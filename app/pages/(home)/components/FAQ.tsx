            ...
            <div className="grid gap-12 lg:grid-cols-7 lg:gap-24">
                <div className="col-span-3">
                    <div className="inline-flex items-center rounded border border-orange-500/10 bg-orange-500/5 p-2">
                        <span className="iconify lucide--help-circle size-5 text-orange-600" />
                    </div>
                    <p className="mt-4 text-3xl font-semibold">Got Questions?</p>
                    <p className="text-base-content/70 mt-3 inline-block max-w-lg">
                        Need assistance? We're here to help! Reach out with any questions or concerns.
                    </p>
